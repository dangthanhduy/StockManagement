...
public class MessageConstants {
	...
	public final static String IMPORT_GOOD_SUCCESSFUL = "Successfull! Quantity of has inscresed: ";
	
	public final static String EXPORT_GOOD_SUCCESSFUL = "Successfull! Good have been exported! ";
	...
	public final static String IMPORT_GOOD_FAILED = "Failed! Import failed. New value must bigger than old value";
	
	public final static String EXPORT_GOOD_FAILED = "Failed! Export failed. The export quantity must smaller than current quantity";
